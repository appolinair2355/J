...
**Fonctionnalités :**
• Surveillance automatique (5 min)
• Messages de réveil automatiques
• Ping périodique (2 min)
• Redémarrage en cas d'inactivité

**Messages de réveil :**
🔔 "Kouamé réveil toi" → Bot
🔔 "Replit réveil toi" → Serveur

Le système maintient votre bot actif 24/7 sur Replit !
        """
